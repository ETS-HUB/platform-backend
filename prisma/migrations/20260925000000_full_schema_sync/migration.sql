...
-- CreateEnum
CREATE TYPE IF NOT EXISTS "Role" AS ENUM ('STUDENT', 'ADMIN', 'RECRUITER', 'TUTOR');

-- CreateEnum
CREATE TYPE IF NOT EXISTS "LearningStyle" AS ENUM ('VISUAL', 'READING', 'HANDS_ON');

-- CreateEnum
CREATE TYPE IF NOT EXISTS "ExperienceLevel" AS ENUM ('BEGINNER', 'INTERMEDIATE', 'ADVANCED');

-- CreateEnum
CREATE TYPE IF NOT EXISTS "Difficulty" AS ENUM ('EASY', 'MEDIUM', 'HARD');

-- CreateEnum
CREATE TYPE IF NOT EXISTS "ContentBlockType" AS ENUM ('TEXT', 'VIDEO', 'CODE', 'IMAGE', 'RESOURCE_LINK', 'PROJECT');

-- CreateEnum
CREATE TYPE IF NOT EXISTS "ResourceType" AS ENUM ('VIDEO', 'ARTICLE', 'EXERCISE', 'DOCUMENTATION', 'TUTORIAL');

-- CreateEnum
CREATE TYPE IF NOT EXISTS "AssignmentType" AS ENUM ('PROJECT', 'EXERCISE', 'QUIZ');

-- CreateEnum
CREATE TYPE IF NOT EXISTS "SubmissionStatus" AS ENUM ('PENDING', 'SUBMITTED', 'IN_REVIEW', 'APPROVED', 'REJECTED', 'RESUBMIT');
